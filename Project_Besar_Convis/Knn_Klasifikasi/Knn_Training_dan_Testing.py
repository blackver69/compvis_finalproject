...
def main():
    ...
    try:
        npaClassifications = np.loadtxt("Knn_Klasifikasi\Data_hasil_klasifikasi\Classifications.txt", np.float32)
    except :
    ...
    try:
        npaFlattenedImages = np.loadtxt("Knn_Klasifikasi\Data_hasil_klasifikasi\Flattened_Images.txt", np.float32)
    except:
    ...
    imgTestingNumbers = cv2.imread("Knn_Klasifikasi\Citra_Plate_Training/training_0.jpg")
