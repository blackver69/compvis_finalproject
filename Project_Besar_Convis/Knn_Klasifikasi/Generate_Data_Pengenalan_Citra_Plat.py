...
def main():
    ...
    training_dataset_dir = os.path.join(current_dir, 'Knn_Klasifikasi\Citra_Plate_Training\dataset')
    ...
    np.savetxt("Knn_Klasifikasi\Data_hasil_klasifikasi\Classifications.txt", npaClassifications)
    np.savetxt("Knn_Klasifikasi\Data_hasil_klasifikasi\Flattened_Images.txt", npaFlattenedImages)         #
